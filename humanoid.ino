...
State state_lookaround(NULL, &on_lookaround_update, &initPosition);
State state_lookforward(NULL, &on_lookforward_update, &initPosition);
State state_lookleft(NULL, &on_lookleft_update, &initPosition);
State state_lookright(NULL, &on_lookright_update, &initPosition);
State state_turnleft(NULL, &on_turnleft_update, &initPosition);
State state_turnright(NULL, &on_turnright_update, &initPosition);
State state_handsup(NULL, &on_handsup_update, NULL);
State state_handsdown(NULL, &on_handsdown_update, NULL);
